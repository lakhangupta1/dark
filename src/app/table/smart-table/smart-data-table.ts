export let settings = {
  ...
  edit: {
    editButtonContent: '<i class="ti-pencil text-info me-2"></i>',
    saveButtonContent: '<i class="ti-save text-success me-2"></i>',
    cancelButtonContent: '<i class="ti-close text-danger"></i>'
  },
  delete: {
    deleteButtonContent: '<i class="ti-trash text-danger me-2"></i>',
    saveButtonContent: '<i class="ti-save text-success me-2"></i>',
    cancelButtonContent: '<i class="ti-close text-danger"></i>'
  }
};
